...
class TicariWindow(QMainWindow):
    ...
    def stok(self):
       try:
        import stok
        self.sp = stok.StokkPenceresi()  # StokkPenceresi sınıfından bir nesne oluşturuluyor
        # self.sp.move(100, 500)  # Pencerenin ekran üzerindeki konumunu ayarlama
        self.sp.show()  # Pencereyi göster
       except Exception as e:
        print("Stok penceresi açılırken bir hata oluştu:", e)
